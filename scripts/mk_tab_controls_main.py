...
rows = [("Ridge on frozen features (trained model)", h["ridge"]["median"], 1.0, x["ridge"][0], 1.0),
        ("Image partition, measured means (domain oracle)", h["img"]["median"], h["img"]["median"] / h["ridge"]["median"], x["img"][0], x["img_frac"][0]),
        ...
        ("Random matched-size partition, measured means", h["rand"]["median"], h["rand"]["median"] / h["ridge"]["median"], x["rand"][0], x["rand_frac"][0])]
