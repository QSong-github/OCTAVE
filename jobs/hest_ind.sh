#!/bin/bash
#SBATCH -J hestind
#SBATCH --qos=qsong1 --partition=hpg-default --array=0-56 -c 4 --mem=32G -t 6:00:00
...
E=${ENC[$SLURM_ARRAY_TASK_ID]}; [ -s results/hest_inductive_${E}.json ] && exit 0
python -u hest_inductive.py $E
