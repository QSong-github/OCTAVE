#!/bin/bash
#SBATCH -J istarxen
#SBATCH --qos=YOUR_QOS --gres=gpu:1 --array=0-15 -c 8 --mem=96G -t 24:00:00
...
ISTAR=/path/to/upstream_istar; RUN=/path/to/project/istar_run; export PYTHONWARNINGS=ignore TQDM_DISABLE=1
