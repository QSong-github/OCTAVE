#!/bin/bash
#SBATCH -J ds_mstar
#SBATCH --qos=YOUR_QOS --partition=YOUR_CPU_PARTITION --array=0-12 -c 4 --mem=24G -t 8:00:00
#SBATCH -o /path/to/project/logs/%x_%A_%a.out
set -e
source /path/to/miniconda3/etc/profile.d/conda.sh; conda activate hest
cd /path/to/project; export OMP_NUM_THREADS=4 BLK_K=20,50,200
A=(mstar); AL=(0.1 1 10 100 1000 10000 100000 1000000 10000000 100000000 1000000000); I=$SLURM_ARRAY_TASK_ID; X=${A[$((I/13))]}; J=$((I%13))
