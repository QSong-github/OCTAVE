...
export HF_HUB_CACHE=/blue/qsong1/wang.qing/phenofm/hf_cache/hub
export HF_HUB_OFFLINE=1
ENC=(dinov3_vitl16 kaiko_vitl14)
E=${ENC[$SLURM_ARRAY_TASK_ID]}
echo "节点 $(hostname)  编码器 $E"
[ "$E" = "kaiko_vitl14" ] && unset HF_HUB_OFFLINE && export HF_HUB_CACHE=/blue/qsong1/wang.qing/systema4ST/.hf/hub
