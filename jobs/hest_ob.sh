#!/bin/bash
#SBATCH -J hestob
#SBATCH --qos=qsong1 --partition=hpg-default --array=0-56 -c 4 --mem=32G -t 8:00:00
#SBATCH -o /blue/qsong1/wang.qing/systema4ST/logs/%x_%A_%a.out
set -e
source /blue/qsong1/wang.qing/miniconda3/etc/profile.d/conda.sh; conda activate hest
cd /blue/qsong1/wang.qing/systema4ST; export OMP_NUM_THREADS=4 OPENBLAS_NUM_THREADS=4 MKL_NUM_THREADS=4
...
E=${ENC[$SLURM_ARRAY_TASK_ID]}; [ -s results/hest_oracle_bands_${E}.json ] && exit 0
python -u hest_oracle_bands.py $E
