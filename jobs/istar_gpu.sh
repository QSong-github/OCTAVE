...
conda activate /blue/qsong1/wang.qing/miniconda3/envs/istar
ISTAR=/blue/qsong1/wang.qing/spatial2exp/iStar        # 只读: 官方仓库
RUN=/blue/qsong1/wang.qing/systema4ST/istar_run
