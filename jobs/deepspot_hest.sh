#!/bin/bash
#SBATCH -J dshest
#SBATCH --qos=YOUR_QOS --partition=hpg-b200 --gres=gpu:1 --array=0-3 -c 6 --mem=64G -t 8:00:00
...
cd /path/to/systema4ST; export PYTHONDONTWRITEBYTECODE=1 TQDM_DISABLE=1 PYTHONWARNINGS=ignore PYTHONPATH=/path/to/systema4ST/methods/DeepSpot:${PYTHONPATH:-}
