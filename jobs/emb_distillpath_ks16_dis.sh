#!/bin/bash
#SBATCH -J emb_distillpath_ks16_dis
#SBATCH --qos=YOUR_QOS --partition=hpg-b200,hpg-rtx6000,hpg-turin --gres=gpu:1 --array=0-6 -c 6 --mem=16G -t 24:00:00
...
A=(distillpath_ks16 distillpath_is16 litefm litefm_s litefm_l litevirchow2 pathryoshka_b); X=${A[$SLURM_ARRAY_TASK_ID]}
