...
#!/bin/bash
#SBATCH -J thitosmoke
#SBATCH --qos=qsong1 --partition=hpg-b200,hpg-rtx6000,hpg-turin --gres=gpu:1 -c 6 --mem=64G -t 4:00:00
...
until [ $(squeue -u wang.qing -r -h -n thito | wc -l) -eq 0 ]; do sleep 120; done
