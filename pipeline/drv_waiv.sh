...
while [ "$(squeue -u wang.qing -r -h -n waivemb | wc -l)" -gt 0 ]; do sleep 60; done
...
while [ "$(squeue -u wang.qing -r -h | wc -l)" -gt 0 ]; do sleep 60; done
say "阶段3 全量重算"
sbatch jobs/chain27.sh >/dev/null
while [ "$(squeue -u wang.qing -r -h -n chain27 | wc -l)" -gt 0 ]; do sleep 20; done
sbatch jobs/agg27.sh >/dev/null
while [ "$(squeue -u wang.qing -r -h -n agg27 | wc -l)" -gt 0 ]; do sleep 20; done
