...
B = getattr(H, "B", "/blue/qsong1/wang.qing/he2st/HEST/eval/bench_data"); EMB = getattr(H, "EMB", "/blue/qsong1/wang.qing/systema4ST/results/hest_emb")
LADDER = H.LADDER; R = "/blue/qsong1/wang.qing/systema4ST/results"
